...
def plot_curve_and_FFT(
    ...
    # 对数坐标系频谱
    ax[2].plot(Fre, FFT_absn, label="FFT")
    ax[2].set_xscale("log")
    ax[2].set_yscale("log")
    ax[2].set_title("(c) FFT in log-log")
    ax[2].set_xlabel("log(Frequency) (log(Hz))")
    ax[2].set_ylabel("log(Amplitude) (log(s))")
